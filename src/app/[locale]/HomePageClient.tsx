    ...
    "@graph": [
      ...
      },
      {
        ...
        offers: {
          ...
          url: "https://www.roblox.com/games/119710171449943/Anime-Overseer",
        },
      },
      {
        "@type": "VideoObject",
        ...
        contentUrl: "https://www.youtube.com/watch?v=9GNQQ3yoJTM",
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              <a
                href="https://www.roblox.com/games/119710171449943/Anime-Overseer"
                target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.youtube.com/watch?v=9GNQQ3yoJTM"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
